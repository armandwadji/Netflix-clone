...
const request = [
  ...
  { title: "Animation", genreUrl: `${baseURL}/discover/movie?api_key=${API_KEY}&language=fr-FR&with_genres=16`, isPoster: false },
  ...
  { title: "Mystères", genreUrl: `${baseURL}/discover/movie?api_key=${API_KEY}&language=fr-FR&with_genres=9648`, isPoster: false },
  ...
  { title: "Western", genreUrl: `${baseURL}/discover/movie?api_key=${API_KEY}&language=fr-FR&with_genres=37`, isPoster: false },
];
